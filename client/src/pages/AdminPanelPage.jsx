...
const dummyAdminStocks = [
  { _id: 's1', symbol: 'AAPL', name: 'Apple Inc.', sector: 'Technology', price: 189.84, isActive: true, description: 'Apple designs, manufactures, and markets smartphones and personal computers.' },
  { _id: 's2', symbol: 'GOOGL', name: 'Alphabet Inc.', sector: 'Technology', price: 141.80, isActive: true, description: 'Alphabet is a holding company for Google and other businesses.' },
  { _id: 's3', symbol: 'MSFT', name: 'Microsoft Corp.', sector: 'Technology', price: 378.91, isActive: true, description: 'Microsoft develops and supports software and services worldwide.' },
  { _id: 's4', symbol: 'AMZN', name: 'Amazon.com Inc.', sector: 'Consumer Goods', price: 178.25, isActive: true, description: 'Amazon engages in the retail sale of consumer products.' },
  { _id: 's5', symbol: 'TSLA', name: 'Tesla Inc.', sector: 'Consumer Goods', price: 248.42, isActive: true, description: 'Tesla designs and sells electric vehicles.' },
  { _id: 's6', symbol: 'META', name: 'Meta Platforms Inc.', sector: 'Technology', price: 505.75, isActive: true, description: 'Meta builds technologies that help people connect.' },
  { _id: 's7', symbol: 'NVDA', name: 'NVIDIA Corp.', sector: 'Technology', price: 875.30, isActive: true, description: 'NVIDIA provides graphics and compute solutions.' },
  { _id: 's8', symbol: 'JPM', name: 'JPMorgan Chase & Co.', sector: 'Finance', price: 198.50, isActive: true, description: 'JPMorgan Chase is a global financial services firm.' },
  { _id: 's9', symbol: 'V', name: 'Visa Inc.', sector: 'Finance', price: 281.30, isActive: true, description: 'Visa operates a global payments technology company.' },
  { _id: 's10', symbol: 'JNJ', name: 'Johnson & Johnson', sector: 'Healthcare', price: 156.20, isActive: true, description: 'Johnson & Johnson operates in the healthcare field.' },
];
...
const AdminPanelPage = () => {
  ...
  const handleStockSubmit = async (e) => {
    e.preventDefault();
    if (!stockForm.symbol || !stockForm.name || !stockForm.price) {
  ...
  const renderStats = () => {
    ...
    const statCards = [
      ...
      { label: 'Active Stocks', value: stats.activeStocks ?? 0, color: 'text-purple-600', bg: 'bg-purple-50 dark:bg-purple-900/20', icon: FiBarChart2 },
                ...
                <tbody>
                  {stocks.map((stock) => (
                    <tr key={stock._id} className="border-b border-gray-100 dark:border-gray-700/50 hover:bg-gray-50 dark:hover:bg-gray-700/30">
                      ...
                      <td className="py-3 px-4 text-right text-gray-900 dark:text-white font-medium">{formatCurrency(stock.price)}</td>
